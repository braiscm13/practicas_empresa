...
/**
 * Deserializer for ThreeTen temporal {@link Instant}s, {@link OffsetDateTime}, and {@link ZonedDateTime}s. Adapted from the jackson threetenbp InstantDeserializer to add support
...
public class CustomInstantDeserializer<T extends Temporal> extends ThreeTenDateTimeDeserializerBase<T> {
	...
	public static final CustomInstantDeserializer<Instant>			INSTANT				= new CustomInstantDeserializer<Instant>(Instant.class, DateTimeFormatter.ISO_INSTANT,
	...
	public static final CustomInstantDeserializer<OffsetDateTime>	OFFSET_DATE_TIME	= new CustomInstantDeserializer<OffsetDateTime>(OffsetDateTime.class,
	...
	public static final CustomInstantDeserializer<ZonedDateTime>	ZONED_DATE_TIME		= new CustomInstantDeserializer<ZonedDateTime>(ZonedDateTime.class,
	...
	protected CustomInstantDeserializer(Class<T> supportedType, DateTimeFormatter parser, Function<TemporalAccessor, T> parsedToValue,
			Function<FromIntegerArguments, T> fromMilliseconds, Function<FromDecimalArguments, T> fromNanoseconds, BiFunction<T, ZoneId, T> adjust) {
	...
	public T deserialize(JsonParser parser, DeserializationContext context) throws IOException {
		...
		switch (parser.getCurrentTokenId()) {
			case JsonTokenId.ID_NUMBER_FLOAT: {
				...
				return this.fromNanoseconds.apply(new FromDecimalArguments(seconds, nanoseconds, this.getZone(context)));
			}
	...
	private ZoneId getZone(DeserializationContext context) {
		...
		return (this._valueClass == Instant.class) ? null : DateTimeUtils.toZoneId(context.getTimeZone());
	}
